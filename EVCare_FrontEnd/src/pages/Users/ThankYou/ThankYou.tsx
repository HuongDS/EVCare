...
import TickIcon from "./CheckAnimation";
...
const MotionButton = styled(motion.button)`
  ...
  box-shadow: 0 4px 15px rgba(0, 173, 78, 0.25);

  &:hover {
    background: ${LIGHT_GREEN};
    transform: translateY(-3px);
    box-shadow: 0 6px 20px rgba(0, 173, 78, 0.35);
  }
`;
    ...
    <PageWrapper>
      {showConfetti && (
        <ReactConfetti
          ...
          recycle={false}
          numberOfPieces={120}
          colors={[MAIN_GREEN, LIGHT_GREEN, "#FFFFFF"]}
        />
      )}
