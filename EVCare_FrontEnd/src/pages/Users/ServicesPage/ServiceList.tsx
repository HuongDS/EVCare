...
=======
            <Container>
                <SortSection>
                    ...
                    <SearchBar handleSearchValue={handleSearchValue} placeholder="Search services..."
                               searchValue={searchValue}/>
                </SortSection>
>>>>>>> main
...
=======
                ...
                {isHaveData && (
                    <Pagination pageIndex={currenPage} totalPage={data?.data?.totalPages || 1}
                                onPageChange={onPageChange}/>
                )}
            </Container>
            <BookingForm loading={loading} setLoading={setLoading} show={showForm}
                         handleClose={() => setShowForm(false)}/>
        </PageContainer>
    );
>>>>>>> main
